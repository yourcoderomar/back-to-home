        ...
        <div class="plan-card">
          ...
          <div class="plan-features">
            ...
            <div class="feature-item" :class="{ disabled: currentPlan.plan_name === 'free' }">
              <q-icon :name="currentPlan.plan_name === 'pro' ? 'check_circle' : 'cancel'" :color="currentPlan.plan_name === 'pro' ? 'positive' : 'grey'" />
            ...
            <div class="plan-card">
              <div class="plan-header">
                ...
                <div class="plan-price" v-if="plan.plan_price > 0">
                  ${{ plan.plan_price }}/month
                    ...
                    <q-btn
                  v-if="plan.plan_name !== currentPlan.plan_name && plan.plan_price > currentPlan.plan_price"
                  unelevated 
                  rounded 
                  class="upgrade-btn" 
                  label="Upgrade" 
              ...
              <div class="plan-features">
                ...
                <div class="feature-item" :class="{ disabled: plan.plan_name === 'free' }">
                  <q-icon :name="plan.plan_name === 'pro' ? 'check_circle' : 'cancel'" :color="plan.plan_name === 'pro' ? 'positive' : 'grey'" />
                  <span>Advanced Search Filters</span>
                </div>
                <div class="feature-item" :class="{ disabled: plan.plan_name === 'free' }">
                  <q-icon :name="plan.plan_name === 'pro' ? 'check_circle' : 'cancel'" :color="plan.plan_name === 'pro' ? 'positive' : 'grey'" />
    ...
    <q-dialog v-model="showConfirmDialog" persistent>
      <q-card>
        <q-card-section class="row items-center">
          ...
          <span class="q-ml-sm">Are you sure you want to delete your subscription? You will be moved to the free plan.</span>
        </q-card-section>
