<template>
  <q-page class="flex flex-center">
    <div class="container">
      ...
      <router-link
        to="/OurPlans"
        class="area area-1 link"
        :data-aos="aosAnimation.area1"
        :data-aos-delay="aosDelay.area1"
      >
        <div class="placeholder">
          <h1>Plans</h1>
          <p>Choose Wisely</p>
        </div>
        <img src="images/8.jpg" alt="Plan image" />
      </router-link>

      <!-- Area 2: Clickable (Navigation) -->
      <router-link
        to="/ReportMissing"
        class="area area-2 link"
        :data-aos="aosAnimation.area2"
        :data-aos-delay="aosDelay.area2"
      >
        <div class="placeholder">
          <h1>Report</h1>
          <p>Missing Person</p>
      ...
      <router-link
        to="SearchMissing"
        class="area area-3 link"
        :data-aos="aosAnimation.area3"
        :data-aos-delay="aosDelay.area3"
      >
        <div class="placeholder">
          <h1>Search</h1>
          <p>Missing Person</p>
        </div>
        <img src="images/9.jpg" alt="Recently found image" />
      </router-link>
    </div>
  </q-page>
</template>
